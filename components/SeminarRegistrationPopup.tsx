                ...
                >
                    ...
                    <div className="relative p-6 md:p-12">
                        ...
                        <form onSubmit={handleSubmit} className="mb-2 md:mb-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 mb-2 md:mb-6">
                                {/* Tên */}
                                <div>
                                    <input
                                        type="text"
                                        ...
                                        required
                                        className={`w-full bg-white border-2 rounded px-3 py-2 text-gray-900 focus:outline-none focus:ring-2 ${errors.name ? "border-red-500 focus:ring-red-500" : "border-[#d4af37] focus:ring-[#d4af37]"
                                            }`}
                                        placeholder="Tên:"
                                    />
                                    {errors.name && (
                                ...
                                <div>
                                    <input
                                        ...
                                        required
                                        min="1"
                                        className={`w-full bg-white border-2 rounded px-3 py-2 text-gray-900 focus:outline-none focus:ring-2 ${errors.participant_count ? "border-red-500 focus:ring-red-500" : "border-[#d4af37] focus:ring-[#d4af37]"
                                            }`}
