                ...
                <div className="flex flex-col">
                    ...
                    <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                            ...
                            <div className="space-y-6">
                                <div className="flex items-center gap-4 bg-white rounded-2xl p-4 border border-[#2a5a4a]">
                                    ...
                                    <div className="text-sm text-deep-green">
                                        <p>Khẳng định năng lực chuyên môn. Chứng nhận xác nhận bạn đã nắm vững kiến thức trang sức, kỹ năng tư vấn cao cấp, quy trình bán hàng xa xỉ và phong thái chuyên nghiệp, giúp bạn nổi bật so với ứng viên phổ thông.</p>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center gap-4 bg-white rounded-2xl p-4 border border-[#2a5a4a]">
                                    ...
                                    <div className="text-sm text-deep-green">
                                        ...
                                        <p>Chứng nhận giúp bạn tăng độ tin cậy khi xét thăng cấp lên:</p>
                        ...
                        <div className="flex justify-center lg:justify-end lg:h-full order-1">
                            <Image
                                src="/images/section11/ce.png"
                                width={3840}
                                height={2789}
                                alt="Certification of Completion - Senior Jewelry Consultant Training Program"
