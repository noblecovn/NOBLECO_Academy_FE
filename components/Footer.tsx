      ...
      <div className="mx-auto max-w-7xl flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="flex flex-col gap-4 order-2 md:order-1">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm">
                <p>72A Đinh Tiên Hoàng, Phường Tân Định,</p>
                <p>TP.Hồ Chí Minh</p>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm">0943 333 197</span>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              href="mailto:contact@noblecoacademy.com"
              className="text-sm hover:underline"
            >
              contact@noblecoacademy.com
            </Link>
          </div>
          <div className="flex items-center gap-4">
            ...
            <Link
              ...
              aria-label="Facebook"
            >
              <svg className="w-5 h-5 text-[#0E3D27]" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="w-full md:w-4/10 order-1 md:order-2">
          <h2 className="text-base text-center text-white font-medium uppercase bg-gradient-to-t from-[#eebc79] to-[#fffaee] bg-clip-text text-transparent">
